...
public abstract class NDSubcomponent extends Component {
    ...
    public NDSubcomponent(ModelFactory model_factory, NDGraphicsConfig hsi_gc) {
    ...
    public NDSubcomponent(ModelFactory model_factory, NDGraphicsConfig hsi_gc, Component parent_component) {
