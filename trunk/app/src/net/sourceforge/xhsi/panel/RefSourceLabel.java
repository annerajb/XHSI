...
* RefSourceLabel.java
* 
* Displays the source name for the HSI at the bottom, in the middle - NAV1, NAV2 or GPS
* 
...
public class RefSourceLabel extends NDSubcomponent {
    ...
    public void paint(Graphics2D g2) {
        ...
        // only in APP and VOR modes
        if ( ( this.avionics.map_submode() == Avionics.EFIS_MAP_APP ) || ( this.avionics.map_submode() == Avionics.EFIS_MAP_VOR ) ) {
            ...
            int source_label_x = (nd_gc.map_center_x + nd_gc.panel_size.width - nd_gc.border_right - text_width ) / 2;
            ...
            if ( ( src_type == TYPE_ILS ) || ( src_type == TYPE_LOC ) ) {
