/**
 * MFDCPSubcomponent.java
 *
 * Superclass for all elements of the MFD Control Panel which are subcomponents of
 * MFDCPcomponent.
 *
...
public abstract class MFDCPSubcomponent extends Subcomponent {
	
	private static final long serialVersionUID = 1L;

    MFDCPGraphicsConfig mfdcp_gc;

    public MFDCPSubcomponent(ModelFactory model_factory, MFDCPGraphicsConfig mfdcp_gc) {
        super(model_factory, mfdcp_gc);

        this.mfdcp_gc = mfdcp_gc;
    ...
    public MFDCPSubcomponent(ModelFactory model_factory, MFDCPGraphicsConfig mfdcp_gc, Component parent_component) {
        this(model_factory, mfdcp_gc);
