                    ...
                    try {
                        ...
                        if ( (info_type ==2) || (info_type == 3) || (info_type == 13) ) {
                            ...
                            nor.add_nav_object(new RadioNavBeacon(
                                    ...
                                    Float.parseFloat(tokens[3]), // elev MSL
                    ...
                    try {
                        ...
                        if (info_type == 1) {
                            ...
                            if ( ! current_airport_saved ) {
                                // position of the ARP (Aerodrome Rference Point)
                                if (hard_rwy_count == 1) {
                            ...
                            if ( ! current_airport_saved )
                                nor.add_nav_object(new Airport(airport_name, airport_icao_code, lat, lon, runways, longest));
