...
//            this.buf_img = create_buffered_image(xhsi_gc.panel_size.width, XHSIGraphicsConfig.STATUS_BAR_HEIGHT);
//            Graphics2D gImg = get_graphics(this.buf_img);
//            render_status_bar(gImg);
//            gImg.dispose();
//        //}
//
//        g2.drawImage(this.buf_img, 0, xhsi_gc.panel_size.height - XHSIGraphicsConfig.STATUS_BAR_HEIGHT, null);
