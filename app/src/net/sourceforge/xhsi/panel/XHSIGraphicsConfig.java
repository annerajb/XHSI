...
public class XHSIGraphicsConfig implements ComponentListener {
    ...
    public XHSIGraphicsConfig(Component root_component) {
        init();
    }
    ...
    public void init() {
        ...
        this.panel_size = new Dimension(XHSIGraphicsConfig.INITIAL_PANEL_WIDTH, XHSIGraphicsConfig.STATUS_BAR_HEIGHT);
        this.border_left = XHSIGraphicsConfig.INITIAL_BORDER_SIZE;
        this.border_right = XHSIGraphicsConfig.INITIAL_BORDER_SIZE;
    ...
    public void update_config(Graphics2D g2, int mode, int submode, int range) {
