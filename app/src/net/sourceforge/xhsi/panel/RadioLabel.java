...
public class RadioLabel extends NDSubcomponent {
        ...
        public RadioBoxInfo(NavigationRadio radio) {
            ...
            if (radio != null) {
                ...
                if (this.receiving == false) {
                    // no reception, display the labels dimmed
    ...
    public void paint(Graphics2D g2) {
        ...
        line_4 = line_3 + nd_gc.line_height_small + 2;
        radio_info_box_height = line_4 + 5;

        if (dme_text_width == 0)
            dme_text_width = nd_gc.get_text_width(g2, nd_gc.font_small, "DME ");
        radio_label_y = nd_gc.panel_size.height - radio_info_box_height - nd_gc.border_bottom;
        ...
        if (this.selected_radio1 != null) {
            if ((this.left_radio_box_buf_image == null) || (radio1_box_info == null) || (radio1_box_info.equals(this.selected_radio1) == false)) {
        ...
        if (this.selected_radio2 != null) {
            if ((this.right_radio_box_buf_image == null) || (radio2_box_info == null) || (radio2_box_info.equals(this.selected_radio2) == false)) {
            ...
            g2.drawImage(this.right_radio_box_buf_image, this.nd_gc.panel_size.width - this.nd_gc.border_right - radio_info_box_width, radio_label_y, null);
        }
    }
