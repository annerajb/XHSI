...
public abstract class XHSISubcomponent extends Component {
    ...
    public XHSISubcomponent(ModelFactory model_factory, XHSIGraphicsConfig hsi_gc) {
    ...
    public XHSISubcomponent(ModelFactory model_factory, XHSIGraphicsConfig hsi_gc, Component parent_component) {
...
//        gImg.setRenderingHints(xhsi_gc.rendering_hints);
